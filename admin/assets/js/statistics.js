...
function displayTop5Customers() {
    ...
    topCustomers.forEach(customer => {
        ...
        customerElement.innerHTML = `
            ...
            <button onclick="viewOrdersByCustomer('${customer.email}')">Hóa đơn người dùng</button>
        `;
...
function viewOrdersByCustomer(email) {
    ...
    let orderDetailsContainer = document.getElementById("order-details-container1");
